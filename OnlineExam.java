...
class OnlineTestBegin extends JFrame implements ActionListener {
    ...
    void set() {
        ...
        if (current == 1) {
            ...
            jb[3].setText("64 and 64");
        }
        if (current == 2) {
            l.setText("Question3: Automatic type conversion is possible in which of the possible cases?");
        ...
        if (current == 3) {
            l.setText("Question4: Select the valid statement");
        ...
        if (current == 4) {
            l.setText("Question5: Which of the following is not an OOPS concept in java?");
        ...
        if (current == 5) {
            l.setText("Question6: Identify the infinite loop?");
            jb[0].setText("for(;;)");
        ...
        if (current == 6) {
            l.setText("Question7: When is the finalize()method called ");
        ...
        if (current == 7) {
            l.setText("Question8: What is the implict return type of constructor?");
        ...
        if (current == 8) {
            l.setText("Question9: The class at the top of exception class is....?");
        ...
        if (current == 9) {
            l.setText("Question10: Which provides runtime enviroment for java byte code to be executed?");
            jb[0].setText("JDK");
            jb[1].setText("JVM");
            jb[2].setText("JRE");
            jb[3].setText("JAVAC");
